...
public class ProductsController {
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(code = 501, message = "Fail", response = Product.class)
        })
    public Product getProduct_more_response(@PathVariable(name = "id") String id) {
        return productsService.getProduct_more_response(id);
    }
